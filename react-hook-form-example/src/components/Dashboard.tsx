...
const Dashboard: React.FC = () => {
  return (
    <div className="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
      {/* Card 1: Total Member */}
      <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow transition duration-300 ease-in-out hover:bg-gray-100">
        ...
        <div className="px-4 text-gray-700">
          ...
          <p className="text-3xl">12,786</p>
        </div>
      </div>

      {/* Card 2 */}
      <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow mt-4 sm:mt-0 transition duration-300 ease-in-out hover:bg-gray-100">
      ...
      {/* Card 3 */}
      <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow mt-4 lg:mt-0 transition duration-300 ease-in-out hover:bg-gray-100">
