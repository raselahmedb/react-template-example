...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className={`h-full ${isSidebarOpen ? 'w-64' : 'w-20'}`}>
      {/* <!-- Navigation Toggle --> */}
      <div className="flex justify-end p-2">
        <button
          type="button"
          onClick={toggleSidebar}
          className="p-2 inline-flex justify-center items-center gap-x-2 rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-transparent dark:border-gray-700 dark:text-white dark:hover:bg-white/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
      ...
      <div
        ...
        className={`hs-overlay ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full' //-translate-x-full translate-x-0
        } transition-transform duration-300 fixed top-0 start-0 bottom-0 z-[60] ${isSidebarOpen ? 'w-52' : 'w-20'} bg-white border-e border-gray-200 lg:block lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700`}
      >
